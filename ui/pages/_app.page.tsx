...
// Status
  ...
  return (
	<div className={styles.container}>	
	  <Head>
        <title>zkApp - Rama Aditya</title>
        <meta name="description" content="ZkApp By Rama Aditya" />
		...
		<main className={styles.main}>
			...
			<div id="homepage" className={styles.homepage}>
				...
				<a id="connectBtn" style={{display: 'block'}} onClick={() => {connectBtnclick(); connectWallet();}}>
					...
					<h1 id="walletTxt" style={{display: 'none'}} className={styles.walletTxt}>Could not find a wallet. <p>Please Install Auro wallet and Re-Connect!!</p> </h1>
			...
			<div id="footer" style={{display: 'block'}} >	
				...
				<a style={{display: 'block'}} href="https://t.me/RamaAditya02" target="_blank" rel="noopener noreferrer" >
						<span className={styles.teleIcon}> </span>
					</a>
					
				<a style={{display: 'block'}} href="https://discordapp.com/users/511855571654148106" target="_blank" rel="noopener noreferrer" >
						<span className={styles.dcIcon}> </span>
					</a>

					<a style={{display: 'block'}} href="https://www.facebook.com/rama.aditya.75641297" target="_blank" rel="noopener noreferrer" >
						<span className={styles.fbIcon}> </span>
					</a>
					
				<a style={{display: 'block'}} href="https://twitter.com/RamaAditya_12" target="_blank" rel="noopener noreferrer" >
						<span className={styles.twtIcon}> </span>
					</a>
